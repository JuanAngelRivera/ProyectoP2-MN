...
public class LinealMultiple extends Ecuacion
{
    ...
    public LinealMultiple()
    {
        ...
        super.descripcion = "La regresión lineal múltiple es una extensión de la regresión lineal simple, en la que se modela"
    + " la relación entre una variable dependiente y dos o más variables independientes. El objetivo sigue siendo"
    + " ajustar un modelo que minimice los errores, pero en este caso se usa un hiperplano en lugar de una recta.\nEste método"
    + " también se desarrolló a partir de los trabajos de Galton y Pearson, pero se generalizó en el siglo XX con el "
    + "desarrollo de la estadística moderna y el álgebra matricial. Hoy en día, es una técnica central en análisis de datos,"
    + " economía, psicología, ingeniería y muchas otras disciplinas.";
    }
